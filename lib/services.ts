...
export const services: Service[] = [
  {
    ...
    image: 'https://placehold.co/800x500/63913D/white?text=Greenhouse+Design',
  },
  {
    ...
    image: 'https://placehold.co/800x500/57D6F2/white?text=Irrigation+Systems',
  },
  {
    ...
    image: 'https://placehold.co/800x500/d97706/white?text=Climate-Smart+Farming',
  },
  {
    ...
    image: 'https://placehold.co/800x500/324f1f/white?text=Agri+Infrastructure',
  },
  {
    ...
    image: 'https://placehold.co/800x500/4f46e5/white?text=Farmer+Training',
  },
  {
    icon: '/wrench.svg',
    ...
    image: 'https://placehold.co/800x500/65a30d/white?text=Maintenance',
  },
];
...
export const serviceSummaries: ServiceSummary[] = [
  {
    ...
    image: 'https://placehold.co/600x400/63913D/white?text=Greenhouses',
  },
  {
    icon: '/irrigation_systems.svg',
    title: 'Irrigation Systems',
    description: 'Efficient water management solutions including drip irrigation, sprinklers, and automated delivery systems.',
    image: 'https://placehold.co/600x400/57D6F2/white?text=Irrigation',
  },
  {
    icon: '/Climate_smart_solutions.svg',
    ...
    image: 'https://placehold.co/600x400/d97706/white?text=Climate-Smart',
  },
  {
    icon: '/Agricultural_infrastructure.svg',
    title: 'Agricultural Infrastructure',
    description: 'Comprehensive infrastructure development from dam liners to specialized crop protection nets.',
    image: 'https://placehold.co/600x400/324f1f/white?text=Infrastructure',
  },
];
