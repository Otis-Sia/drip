...
export default function TeamCard({ member }: TeamCardProps) {
  ...
  return (
    <div className="card p-6 group text-center">
      {/* Avatar */}
      <div className="w-24 h-24 rounded-full mx-auto mb-5 bg-gradient-to-br from-primary to-primary-light flex items-center justify-center shadow-lg shadow-primary/15 group-hover:scale-105 transition-transform duration-300 overflow-hidden relative">
        {member.image ? (
